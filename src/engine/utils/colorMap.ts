...
colorMap.set('hot_and_color_new1', [
  { index: 0, rgb: [0, 255, 255] },
  { index: 0.05, rgb: [0, 235, 255] },
  { index: 0.1, rgb: [0, 215, 255] },
  { index: 0.15, rgb: [0, 185, 255] },
  { index: 0.2, rgb: [0, 155, 255] },
  { index: 0.25, rgb: [0, 125, 255] },
  { index: 0.3, rgb: [0, 65, 255] },
  { index: 0.35, rgb: [0, 30, 255] },
  { index: 0.4, rgb: [0, 0, 185] },
  { index: 0.45, rgb: [0, 0, 127] },
  { index: 0.5, rgb: [60, 0, 117] },
  { index: 0.55, rgb: [120, 0, 109] },
  { index: 0.6, rgb: [150, 0, 70] },
  { index: 0.65, rgb: [195, 0, 20] },
  { index: 0.7, rgb: [255, 0, 0] },
  { index: 0.75, rgb: [255, 50, 0] },
  { index: 0.8, rgb: [255, 90, 0] },
  { index: 0.85, rgb: [255, 140, 0] },
  { index: 0.9, rgb: [255, 205, 0] },
  { index: 0.95, rgb: [255, 255, 0] },
  { index: 1, rgb: [255, 255, 195] },
]);
colorMap.set('spring', [
